...
import muti6 from '@/assets/muti6.jpg'
...
<template>
  ...
  >
    ...
    <span class="floaty pointer-events-none absolute left-[10%] top-[15%] text-3xl opacity-70">💕</span>
    <span class="floaty pointer-events-none absolute right-[8%] top-[10%] text-2xl opacity-60" style="animation-delay: 0.5s">✨</span>
    <span class="floaty pointer-events-none absolute left-[6%] bottom-[18%] text-2xl opacity-60" style="animation-delay: 1s">🌸</span>
    <span class="floaty pointer-events-none absolute right-[14%] bottom-[12%] text-3xl opacity-70" style="animation-delay: 1.5s">💫</span>

    <div class="page5-enter relative grid w-full max-w-6xl grid-cols-1 items-center gap-16 lg:grid-cols-2">

      <!-- Kiri: teks besar (rata kanan) -->
      <div class="flex flex-col items-end gap-5 text-right">
        ...
        <p class="max-w-md text-lg text-white/80">
          Setiap halaman yang kita lewati adalah bagian kecil dari kisah yang ingin kubagi denganmu, perlahan tapi pasti🕊️
        </p>

        <!-- Kartu kutipan kecil, glass premium -->
        <div class="w-full max-w-md rounded-3xl border border-white/15 bg-white/5 p-6 text-left shadow-2xl backdrop-blur-md">
          <p class="text-xs uppercase tracking-widest text-white/50">Catatan kecil</p>
          <p class="mt-2 text-lg font-semibold">
            "Bersamamu, hal sederhana pun terasa istimewa." 💕
          </p>
        </div>
      ...
      <div class="flex justify-center lg:justify-self-end">
        ...
        >
          <img :src="muti6" alt="Gambar kenangan" class="h-full w-full object-cover" />
          <div
...
.page5-enter {
  animation: page5SlideIn 0.7s ease-out both;
}
